...
func resourceArmVirtualMachineScaleSet() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"virtual_machine_os_profile_windows_config": &schema.Schema{
				Type:     schema.TypeSet,
				Optional: true,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
...
func resourceArmVirtualMachineScaleSetRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("virtual_machine_os_profile", flattenAzureRMVirtualMachineScaleSetOsProfile(resp.Properties.VirtualMachineProfile.OsProfile)); err != nil {
	...
	if resp.Properties.VirtualMachineProfile.OsProfile.Secrets != nil {
		if err := d.Set("virtual_machine_os_profile_secrets", flattenAzureRmVirtualMachineScaleSetOsProfileSecrets(resp.Properties.VirtualMachineProfile.OsProfile.Secrets)); err != nil {
	...
	if resp.Properties.VirtualMachineProfile.OsProfile.WindowsConfiguration != nil {
		if err := d.Set("virtual_machine_os_profile_windows_config", flattenAzureRmVirtualMachineScaleSetOsProfileWindowsConfig(resp.Properties.VirtualMachineProfile.OsProfile.WindowsConfiguration)); err != nil {
	...
	if resp.Properties.VirtualMachineProfile.OsProfile.LinuxConfiguration != nil {
		if err := d.Set("virtual_machine_os_profile_linux_config", flattenAzureRmVirtualMachineScaleSetOsProfileLinuxConfig(resp.Properties.VirtualMachineProfile.OsProfile.LinuxConfiguration)); err != nil {
			return fmt.Errorf("[DEBUG] Error setting Virtual Machine Scale Set OS Profile Windows config error: %#v", err)
		}
	}

	if err := d.Set("virtual_machine_network_profile", flattenAzureRmVirtualMachineScaleSetNetworkProfile(resp.Properties.VirtualMachineProfile.NetworkProfile)); err != nil {
	...
	if resp.Properties.VirtualMachineProfile.StorageProfile.ImageReference != nil {
		if err := d.Set("virtual_machine_storage_profile_image_reference", flattenAzureRmVirtualMachineScaleSetStorageProfileImageReference(resp.Properties.VirtualMachineProfile.StorageProfile.ImageReference)); err != nil {
			return fmt.Errorf("[DEBUG] Error setting Virtual Machine Scale Set Storage Profile Image Reference error: %#v", err)
		}
	}

	if err := d.Set("virtual_machine_storage_profile_os_disk", flattenAzureRmVirtualMachineScaleSetStorageProfileOSDisk(resp.Properties.VirtualMachineProfile.StorageProfile.OsDisk)); err != nil {
...
func flattenAzureRmVirtualMachineScaleSetStorageProfileOSDisk(profile *compute.VirtualMachineScaleSetOSDisk) []interface{} {
	...
	result["vhd_containers"] = *profile.VhdContainers
...
func expandAzureRMVirtualMachineScaleSetsOsProfile(d *schema.ResourceData) (*compute.VirtualMachineScaleSetOSProfile, error) {
	...
	if _, ok := d.GetOk("virtual_machine_os_profile_secrets"); ok {
	...
	if _, ok := d.GetOk("virtual_machine_os_profile_linux_config"); ok {
	...
	if _, ok := d.GetOk("virtual_machine_os_profile_windows_config"); ok {
